...
class NoiseModelBase:
    def __init__(self, dist, prms_def, sensors, name=None, correlation=None,
                 noise_type='additive'):
        """
        Parameters
        ----------
        ...
        correlation : dict, None, optional
...
class NormalNoiseModel(NoiseModelBase):
    ...
    def __init__(self, prms_def, sensors, name=None, correlation=None,
        ...
        ----------
        prms_def : str, list[str], dict
            The parameters of the noise model. Currently, this noise model needs
            to have a 'std'-parameter which describes the standard deviation.
            Also the parameter 'mean' can be given.
        sensors : str, list[str]
            Names of the sensors that are required to evaluate the noise model.
        name : str, None, optional
            Unique name of the noise model. This name is None, if the user does
        ...
        super().__init__('normal', prms_def, sensors, name=name,
                         correlation=correlation, noise_type=noise_type)
