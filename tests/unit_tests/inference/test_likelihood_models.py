...
from probeye.inference.likelihood_models import (
    ...
    AdditiveCorrelatedModelErrorS23D,
    AdditiveCorrelatedModelError1D1D,
    AdditiveCorrelatedModelError1DS23D,
    MultiplicativeUncorrelatedModelError,
    MultiplicativeCorrelatedModelError1D,
    MultiplicativeCorrelatedModelErrorS23D,
    MultiplicativeCorrelatedModelError1D1D,
    MultiplicativeCorrelatedModelError1DS23D,
)

#
# class UncorrelatedForwardModel(ForwardModelBase):
#     """
#     Simple forward model without correlation for testing. It is defined outside the test
#     routines so it does not have to be re-defined multiple times for different tests.
#     """
#
#     def interface(self):
...
class TestProblem(unittest.TestCase):
    ...
    #         )
    #
    # def test_AdditiveCorrelatedModelErrorS23D(self):
    #
    #     # prepare the dummy problem experiments
    #     n_data_points_exp = 100
    #     dummy_data = np.linspace(-1, 1, n_data_points_exp)
    ...
    #     lm_base.problem_experiments = problem_experiments
    #     like_model_translated = translate_likelihood_model(lm_base)
    #     assert type(like_model_translated) is AdditiveCorrelatedModelErrorS23D
    #
    #     # checks for additive_measurement_error=False
    #     like_model = AdditiveCorrelatedModelErrorS23D(
    #         prms_def=["std_model", "l_corr"],
    #         experiment_names=["Exp_1", "Exp_2"],
    #         additive_measurement_error=False,
    #         correlation_variables="xy",
    ...
    #         )
    #
    # def test_AdditiveCorrelatedModelError1D1D(self):
    #
    #     # prepare the dummy problem experiments
    #     n_data_points_exp = 100
    #     dummy_data = np.linspace(-1, 1, n_data_points_exp)
    ...
    #     lm_base.problem_experiments = problem_experiments
    #     like_model_translated = translate_likelihood_model(lm_base)
    #     assert type(like_model_translated) is AdditiveCorrelatedModelError1D1D
    #
    #     # checks for additive_measurement_error=False
    #     like_model = AdditiveCorrelatedModelError1D1D(
    #         prms_def=["std_model", "l_corr_space", "l_corr_time"],
    #         experiment_names=["Exp_1", "Exp_2"],
    #         additive_measurement_error=False,
    #         correlation_variables="xt",
    ...
    #         )
    #
    # def test_AdditiveCorrelatedModelError1DS23D(self):
    #
    #     # prepare the dummy problem experiments
    #     n_data_points_exp = 100
    #     dummy_data = np.linspace(-1, 1, n_data_points_exp)
    ...
    #     lm_base.problem_experiments = problem_experiments
    #     like_model_translated = translate_likelihood_model(lm_base)
    #     assert type(like_model_translated) is AdditiveCorrelatedModelError1DS23D
    #
    #     # checks for additive_measurement_error=False
    #     like_model = AdditiveCorrelatedModelError1DS23D(
    #         prms_def=["std_model", "l_corr_space", "l_corr_time"],
    #         experiment_names=["Exp_1", "Exp_2"],
    #         additive_measurement_error=False,
    #         correlation_variables="xyt",
    ...
    #     self.assertAlmostEqual(computed_ll, expected_ll)
    #
    # def test_MultiplicativeCorrelatedModelErrorS23D(self):
    #
    #     # prepare the dummy problem experiments
    #     n_data_points_exp = 100
    #     dummy_data = np.linspace(-1, 1, n_data_points_exp)
    ...
    #     lm_base.problem_experiments = problem_experiments
    #     like_model_translated = translate_likelihood_model(lm_base)
    #     assert type(like_model_translated) is MultiplicativeCorrelatedModelErrorS23D
    #
    ...
    #
    #     # checks for additive_measurement_error=False
    #     like_model = MultiplicativeCorrelatedModelErrorS23D(
    #         prms_def=["std_model", "l_corr"],
    #         sensors=[Sensor("z")],
    #         experiment_names=["Exp_1", "Exp_2"],
    #         problem_experiments=problem_experiments,
    ...
    #     self.assertAlmostEqual(computed_ll, expected_ll)
    #
    # def test_MultiplicativeCorrelatedModelError1D1D(self):
    #
    #     # prepare the dummy problem experiments
    #     n_data_points_exp = 100
    #     dummy_data = np.linspace(-1, 1, n_data_points_exp)
    ...
    #     lm_base.problem_experiments = problem_experiments
    #     like_model_translated = translate_likelihood_model(lm_base)
    #     assert type(like_model_translated) is MultiplicativeCorrelatedModelError1D1D
    #
    #     # checks for additive_measurement_error=False
    #     like_model = MultiplicativeCorrelatedModelError1D1D(
    #         prms_def=["std_model", "l_corr_space", "l_corr_time"],
    #         sensors=[Sensor("z1"), Sensor("z2")],
    #         experiment_names=["Exp_1", "Exp_2"],
    #         problem_experiments=problem_experiments,
    ...
    #     self.assertAlmostEqual(computed_ll, expected_ll)
    #
    # def test_MultiplicativeCorrelatedModelError1DS23D(self):
    #
    #     # prepare the dummy problem experiments
    #     n_data_points_exp = 100
    #     dummy_data = np.linspace(-1, 1, n_data_points_exp)
    ...
    #     lm_base.problem_experiments = problem_experiments
    #     like_model_translated = translate_likelihood_model(lm_base)
    #     assert type(like_model_translated) is MultiplicativeCorrelatedModelError1DS23D
    #
    #     # checks for additive_measurement_error=False
    #     like_model = MultiplicativeCorrelatedModelError1DS23D(
    #         prms_def=["std_model", "l_corr_space", "l_corr_time"],
    #         sensors=[Sensor("z1"), Sensor("z2")],
    #         experiment_names=["Exp_1", "Exp_2"],
    #         problem_experiments=problem_experiments,
