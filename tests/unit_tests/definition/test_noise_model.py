...
class TestProblem(unittest.TestCase):
    def test_init(self):
        ...
        noise_template = NoiseModelBase("normal", ["bias", "sigma"], Sensor("y"))
        self.assertEqual(noise_template.prms_def, {"bias": "bias", "sigma": "sigma"})
        self.assertEqual(noise_template.prms_dim, 2)
        noise_template = NoiseModelBase("normal", ["b", {"sd": "sigma"}], Sensor("y"))
