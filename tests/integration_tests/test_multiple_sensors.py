...
from probeye.definition.sensor import Sensor, SensorWithCoordinates
...
class TestProblem(unittest.TestCase):
    ...
    def test_multiple_sensors(self, n_steps=100, n_walkers=20, plot=False,
        ...
        isensor = Sensor("time")
        osensor1 = SensorWithCoordinates("y1", x=pos_s1)
        osensor2 = SensorWithCoordinates("y2", x=pos_s2)
        osensor3 = SensorWithCoordinates("y3", x=pos_s3)
